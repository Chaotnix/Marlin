...
#define STRING_CONFIG_H_AUTHOR "(chaotnix, Ender-3)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 Trianglelab All Metal Hotend
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 84.59
  #define DEFAULT_bedKi 13.70
  #define DEFAULT_bedKd 348.08
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { +32, -2, -0.86 }
